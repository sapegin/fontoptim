...
function FontOptim(fonts, options) {
	...
	this.fontFaceTemplate = _.template(this.fontFaceTemplate);
	this.fontUriTemplate = _.template(this.fontUriTemplate);
}
...
FontOptim.prototype = {
	...
	generate: function() {
		...
		formats = _.mapValues(formats, this.prependBannerAndJoinLines.bind(this));
		return formats;
	},
